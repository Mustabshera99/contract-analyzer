...
class IntegrationService:
	...
	async def send_contract_analysis_alert(self, contract_name: str, risk_level: str, analysis_url: str) -> bool:
		"""Send contract analysis alert to all enabled notification integrations"""
		success = True
	...
	async def send_contract_analysis_email(
		...
		try:
			...
			logger.error(f"Failed to send contract analysis email for {integration_name}: {e}")
			return False
	...
	async def send_contract_analysis_alert(
		...
		try:
			...
			logger.error(f"Failed to send contract analysis alert for {integration_name}: {e}")
			return False
